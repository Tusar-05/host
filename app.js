...
async function handleLogin(e) {
    ...
    try {
        ...
        errorEl.textContent = 'Login failed. Please check your username.';
...
function configureRoleUI() {
    // Hide all tabs first
    const tabs = ['nav-capacity', 'nav-bottleneck', 'nav-data', 'nav-brief', 'nav-patient-list', 'nav-my-portal'];
    ...
    if (role === 'admin') {
        ['nav-capacity', 'nav-bottleneck', 'nav-data', 'nav-brief'].forEach(t => document.getElementById(t).style.display = '');
